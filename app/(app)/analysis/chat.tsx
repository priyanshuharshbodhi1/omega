          ...
          <div className="pb-28">
            ...
            {isLoading && (
              <div className="mb-2 flex justify-start">
                <div className="inline-block max-w-[80%] rounded-t-2xl rounded-br-2xl border border-slate-200 bg-white p-3 text-sm shadow-sm">
      ...
      <div className="fixed bottom-4 left-4 right-4 lg:right-8 lg:left-72">
        <div className="max-w-2xl mx-auto shadow-xl">
          <form
            ...
            className="overflow-hidden rounded-lg border bg-background focus-within:ring-1 focus-within:ring-ring bg-white"
          >
